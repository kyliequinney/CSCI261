...
bool run_all_tests()  {
    ...
    totalPassed += test_int(           totalNumTests,  "Testing string_length()",              string_length("Now") , 3 );
    totalPassed += test_int(           totalNumTests,  "Testing string_length()",              string_length("Tablet") , 6 );
    totalPassed += test_int(           totalNumTests,  "Testing string_length()",              string_length("") , 0 );
    ...
    totalPassed += test_int(           totalNumTests,  "Testing string_find()",                string_find("Have to face reality now.", 'o') , 6 );
    totalPassed += test_int(           totalNumTests,  "Testing string_find()",                string_find("Have to face reality now.", 'e') , 3 );
    ...
    totalPassed += test_string(        totalNumTests,  "Testing string_remove_first_word()",   string_remove_first_word(string_remove_first_word("The quick brown fox jumped over the lazy dog")) , "brown fox jumped over the lazy dog" );
    ...
    totalPassed += test_string(        totalNumTests,  "Testing string_substitute()",          string_substitute(string_substitute("D--", '-', '+'), 'D', 'C') , "C++" );
